...
class UsersTableSeeder extends Seeder
{
	...
	public function run()
	{
		$users = [
			...
			['id' => 4, 'first_name' => 'Admin', 'last_name' => 'App', 'email' => 'geovannyalonso@gmail.com', 'password' => \Hash::make('Ludum2015'), 'role_id' => 2],
			['id' => 5, 'first_name' => 'Jugador', 'last_name' => '1', 'email' => 'geovannyalonso@gmail.com', 'password' => \Hash::make('Ludum2015'), 'role_id' => 3],
			['id' => 6, 'first_name' => 'Jugador', 'last_name' => '2', 'email' => 'geovannyalonso@gmail.com', 'password' => \Hash::make('Ludum2015'), 'role_id' => 3]
		];
