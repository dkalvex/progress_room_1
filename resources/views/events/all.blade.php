		...
		<div class="col-xs-12">
			<div class="page-header">
				<div class="pull-right form-inline">
					...
					<div class="btn-group">
						<button class="btn btn-default" data-calendar-nav="prev"><i class="fa fa-chevron-left" style="margin-right: 5px"></i> Prev</button>
						<button class="btn btn-info" data-calendar-nav="today">Today</button>
						<button class="btn btn-default" data-calendar-nav="next">Next <i class="fa fa-chevron-right" style="margin-left: 5px"></i></button>
					</div>
					<div class="btn-group">
